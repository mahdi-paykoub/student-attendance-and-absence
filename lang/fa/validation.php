...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'parent' => 'مادر',
        'duration' => 'مدت زمان',
        'negative_marking' => 'نمره منفی',
        'total_marks' => 'امتیاز کلی',
        'exam_type' => 'نوع آزمون',
        'start_time' => 'زمان شروع',
        'is_paid' => 'نوع هزینه',
        'price' => 'قیمت',
        'questions_per_page' => 'تعداد سوال',
        'show_score_after_submit' => 'نمایش نتیجه',
        'allow_back' => 'اجازه بازگشت',
        'shuffle_questions' => 'سوالات تصادفی',
        'shuffle_options' => 'گزینه تصادفی',
        'text_editor' => 'ادیتور متن',
        'cover' => 'تصویر',
